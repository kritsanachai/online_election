					...
					<div class="row align-items-center">
						...
						<div class="top-nav-search" style = "margin-top : 35px;">
								<form action = "all-events.php" method = "post">
									...
									<input type="text" class="form-control" placeholder="ค้นหารายการ" name="search">
									<button class="btn" type="submit" name = "keyword"><i class="fas fa-search"></i></button>
								</form>
							</div>
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">รายการทั้งหมด (All Events)</h4>
									...
									<table class="datatable table table-stripped table table-hover table-center mb-0">
										<thead>
											<tr>
												...
												<th>เปิด</th>
												<th>ปิด</th>
                                                <th class="text-center">เพิ่มผู้สมัคร</th>
										...
										<tbody>
											...
											<tr>
                                                ...
                                                <td>
                                                    <center>
													<div class="actions"> <a href="candidete.php?event=<?php echo $event_id;?>" class="btn btn-sm bg-warning-light mr-2">เพิ่ม</a> </div>
                                                    </center>
												</td>
												...
												<td class="text-right">
													<div class="dropdown dropdown-action"> <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v ellipse_color"></i></a>
														<div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="edit-events.php?eventid=<?php echo $event_id;?>&num=<?php echo $x;?>"><i class="fas fa-pencil-alt m-r-5"></i> แก้ไข</a> <a class="dropdown-item" href="del-events.php?eventid=<?php echo $event_id;?>"  onclick="return ConfirmDelete()"><i class="fas fa-trash-alt m-r-5"></i> ลบ</a> </div>
													</div>
												</td>
											</tr>
											<?php } ?>
